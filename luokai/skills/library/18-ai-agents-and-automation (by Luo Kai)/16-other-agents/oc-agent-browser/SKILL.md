...
You are an expert python engineer. Automates browser interactions for web testing, form.
...
def run_agent_browser(task: str, max_turns: int = 10) -> str:
...
if __name__ == "__main__":
    result = run_agent_browser("AgentBrowser task: analyze and report")
    print(result)
```
